        ...
        <div class="row text-center">
            <div class="col-4 p-3 text-justify">
                ...
                <ul class="nav flex-column">
                    <li class=""><a href="<?php echo base_url('/');?>" class="nav-link p-0 text-body-secondary">Pagina
                            Principal</a>
                    </li>
                    <li class="nav-item mb-2"><a href="<?php echo base_url('quienes_somos');?>"
                            class="nav-link p-0 text-body-secondary">¿Quienes somos?</a></li>
                    <li class="nav-item mb-2"><a href="<?php echo base_url('comercializacion');?>"
                            class="nav-link p-0 text-body-secondary">Catalogo</a></li>
                </ul>
            </div>
            ...
            <div class="col-4 p-3 text-justify align-items-center">
